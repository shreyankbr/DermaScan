...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function startDiagnosis() {
        ...
        try {
            ...
            if (!file.type.match('image.*')) {
                throw new Error("Only image files are allowed (JPEG, PNG)");
            }
            ...
            showToast(`Diagnosis failed: ${errorMessage}`, 'error');
            resetAnalyzeButton();
    ...
    function resetAnalyzeButton() {
        diagnoseBtn.innerHTML = '<i class="fas fa-search"></i> Diagnose';
        diagnoseBtn.disabled = false;
    }
    ...
    async function generatePDFReport() {
        ...
        try {
            ...
            // Patient Info - Now using the properly retrieved patientName
            doc.setFontSize(12);
